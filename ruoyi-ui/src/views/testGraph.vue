<template>
  <div>
    ...
    <div v-if="showContextMenu" :style="{ left: graphMenuPosition.x + 'px', top: graphMenuPosition.y + 'px' }" class="graph-menu">
...
<!--    <el-card v-if="showContextMenu" :style="{ left: graphMenuPosition.x + 'px', top: graphMenuPosition.y + 'px' }" class="context-menu">-->
